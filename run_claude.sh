...
if grep -q "REACT_APP_CLAUDE_API_KEY=" .env && ! grep -q "REACT_APP_CLAUDE_API_KEY=sk-" .env; then
  echo "WARNING: No Claude API key found. The app will run in mock mode."
  echo "To use the real Claude API, edit the .env file and add your API key."
